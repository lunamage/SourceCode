...
import com.smzdm.entity.ItemEntity;
import com.smzdm.entity.PropertyEntity;
import com.smzdm.utils.DateUtils;
import com.smzdm.utils.Hashids;
...
public class MessageSplitter extends RichFlatMapFunction<String, Tuple4<String, String, String, Long>> {
    ...
    public void open(Configuration parameters) {
        ...
        this.jedisPool = new JedisPool(config, properties.getProperty("redis.article.detail"),
    ...
    public void flatMap(String msg, Collector<Tuple4<String, String, String, Long>> collector) {
        try {
            ...
            // 曝光数据
            if (Objects.equals("show", entity.getType()) && IMP_EA_VAL.contains(entity.getEa())
                    && IMP_EC_VAL.contains(entity.getEc())) {
