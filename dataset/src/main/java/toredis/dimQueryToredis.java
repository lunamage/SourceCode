 ...
 * @Description: 实时特征计算
 */
public class dimQueryToredis {
	
	private static Logger log = LoggerFactory.getLogger(dimQueryToredis.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<String> hdfsLines = env.readTextFile("hdfs://cluster/bi/dw_ga/dim_query_toredis");
