CREATE TABLE dev_ga_data_warehouse.t_fact_GMV_offline_200814 LIKE dev_ga_data_warehouse.t_fact_GMV_offline;

insert into t_fact_GMV_offline_200814 select * from t_fact_GMV_offline;
