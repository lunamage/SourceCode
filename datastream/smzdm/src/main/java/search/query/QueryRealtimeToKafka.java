...
public class QueryRealtimeToKafka {
    ...
    public static void main(String[] args) throws Exception {
         ...
         t3.addSink(new FlinkKafkaProducer<String>(ReadConfig.getProperties("bootstrap2.servers"),ReadConfig.getProperties("kafka.search.topic"),new SimpleStringSchema())).name("flink-connectors-kafka3");
         t12.addSink(new FlinkKafkaProducer<String>(ReadConfig.getProperties("bootstrap2.servers"),ReadConfig.getProperties("kafka.search.topic"),new SimpleStringSchema())).name("flink-connectors-kafka12");
