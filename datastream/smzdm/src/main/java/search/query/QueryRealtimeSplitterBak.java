 ...
 * @Description:
 */
public class QueryRealtimeSplitterBak extends RichFlatMapFunction<String, Tuple5<String, String, Double, String, Long>> {

    /**
	 * 
	 */
	private static final long serialVersionUID = -8284916412921643582L;
	private static Logger log = LoggerFactory.getLogger(QueryRealtimeSplitterBak.class);
    ...
    public void flatMap(String msg, Collector<Tuple5<String, String, Double, String, Long>> collector) {
		...
		try {
			...
			if(ec.equals("搜索")) {
				...
				String queryBase64 = Base64.getEncoder().encodeToString(query.toUpperCase().getBytes("UTF-8"));
