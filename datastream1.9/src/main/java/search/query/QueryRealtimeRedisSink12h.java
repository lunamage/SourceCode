...
public class QueryRealtimeRedisSink12h extends RichSinkFunction<QueryRealtime.ItemFeatureEntity> {
	 private static Logger log = LoggerFactory.getLogger(QueryRealtimeRedisSink12h.class);
	  ...
	  private JedisPool jedisPool;
	    ...
	    public void invoke(QueryRealtime.ItemFeatureEntity value, SinkFunction.Context context) {
	        ...
	        map.put(queryId+"_12ht", windowEnd);
	        map.put(queryId+"_12h_rf", JSONObject.toJSONString(queryClickRfMap));
	        map.put(queryId+"_12h_rank", JSONObject.toJSONString(queryClickRankMap));
	        map.put(queryId+"_12h_rank_rf", JSONObject.toJSONString(queryClickRankRfMap));
	        map.put(queryId+"_12h_ratio", JSONObject.toJSONString(queryClickratioMap));
	        if (queryCtrMap.size() != 0) {
	        	map.put(queryId+"_12h_ctr", JSONObject.toJSONString(queryCtrMap));
	        	queryCtrRankMap = Utils.mapOrder(queryCtrMap);
	        	map.put(queryId+"_12h_ctr_rank", JSONObject.toJSONString(queryCtrRankMap));
	        }
