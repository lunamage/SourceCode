 ...
 */
public class QueryRealtimeToKafkaBak {
    ...
    public static void main(String[] args) throws Exception {
         ...
         //env.setStateBackend((StateBackend) new RocksDBStateBackend("hdfs://HDFS80727/bi/flink/checkpoint",true));
         //env.setStateBackend((StateBackend) new FsStateBackend("file:///data",true));
         ...
         KeyedStream<Tuple5<String, String, Double, String, Long>, Tuple> keyedStream = env.addSource(myConsumer).filter((FilterFunction<String>) log -> {
        	 //log = new String(log.getBytes(),"GBK");
